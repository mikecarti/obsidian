...
\end{align}
$$
Let us reframe the model. It is equivallent to only 1 hedgehog, that either moves 2 steps, or is staying where he is. With 1/2 proba. that he moves 2 steps, and 1/2 proba. that he will not move.
$$
\begin{align}
= 1 + 
\end{align}
